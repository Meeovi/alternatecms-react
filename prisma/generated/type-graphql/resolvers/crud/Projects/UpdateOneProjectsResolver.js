...
exports.UpdateOneProjectsResolver = void 0;
const tslib_1 = require("tslib");
const TypeGraphQL = tslib_1.__importStar(require("type-graphql"));
const UpdateOneProjectsArgs_1 = require("./args/UpdateOneProjectsArgs");
const Projects_1 = require("../../../models/Projects");
const helpers_1 = require("../../../helpers");
let UpdateOneProjectsResolver = class UpdateOneProjectsResolver {
...
], UpdateOneProjectsResolver.prototype, "updateOneProjects", null);
UpdateOneProjectsResolver = tslib_1.__decorate([
    TypeGraphQL.Resolver(_of => Projects_1.Projects)
], UpdateOneProjectsResolver);
exports.UpdateOneProjectsResolver = UpdateOneProjectsResolver;
