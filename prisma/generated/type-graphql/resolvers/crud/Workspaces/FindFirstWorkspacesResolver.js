...
exports.FindFirstWorkspacesResolver = void 0;
...
let FindFirstWorkspacesResolver = class FindFirstWorkspacesResolver {
...
], FindFirstWorkspacesResolver.prototype, "findFirstWorkspaces", null);
FindFirstWorkspacesResolver = tslib_1.__decorate([
    TypeGraphQL.Resolver(_of => Workspaces_1.Workspaces)
], FindFirstWorkspacesResolver);
exports.FindFirstWorkspacesResolver = FindFirstWorkspacesResolver;
